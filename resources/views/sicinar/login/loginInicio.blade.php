...
/*------------------------------ logininicio.blade.php ---------------------------------------------------
 ...
 Sistema:   SRP v.1
 Fecha última modificación:  septiembre 2021
 ---------------------------------------------------------------------------------------------------*/
#wrap{
  text-align:left;
  height: 600px;
...
<body class="hold-transition">
  ...
  <div class="login-logo">
      <h4 style="color:green;" width="80">
          <b>SECRETARIA DE DESARROLLO SOCIAL <br> UNIDAD DE DESARROLLO INSTITUCIONAL Y TECNOLOGIAS DE LA INFORMACIÓN (UDITI)<br>
          <b style="color:orange;">CATALOGO DE PROGRAMAS (CATPROG) </b>
      </h4>
  </div>
      ...
      {!! Form::open(['route' => 'login', 'method' => 'POST', 'id' => 'logeo']) !!}
        ...
        <div class="col-md-12 offset-md-5">
            ...
            <a href="{{route('autoregusu')}}" class="btn btn-primary btn_xs" title="Autoregistrse para generar un folio">
                ...
                <span class="glyphicon glyphicon-plus"></span>Auto registrarse
            </a>
            &nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <div class="lockscreen-footer text-center">
      <b>Copyright &copy;. Derechos reservados. Secretaría de Desarrollo Social - Unidad de Desarrollo Institucional y Tecnologias de la Información (UDITI).</b>
  </div>
