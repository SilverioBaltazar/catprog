            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => 'altanuevodistbenemetas', 'method' => 'POST','id' => 'nuevodistbenemetas', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\distbenemetasRequest','#nuevodistbenemetas') !!}
@endsection
