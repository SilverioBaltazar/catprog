    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1><i class="fa fa-dashboard"></i>&nbsp;&nbsp;Menú.
                ...
                <small>8.1 Dist. beneficios metas -</small> 
                    ...
                    <div class="box">
                        ...
                        <div class="page-header" style="text-align:right;">
                            @if(session()->get('rango') == '4')                                        
                                {{ Form::open(['route' => 'buscardistbenemetas', 'method' => 'GET', 'class' => 'form-inline pull-right']) }}
                                    ...
                                    <div class="box-header" style="text-align:right;">
                                        <a href="{{route('nuevodistbenemetas')}}" class="btn btn-primary btn_xs" title="Nueva Distribución de beneficios"><i class="fa fa-file-new-o"></i><span class="glyphicon glyphicon-plus"></span>Nueva Distribución de beneficios </a> 
                                    </div>
                                {{ Form::close() }}
                            @else
                                <div class="box-header" style="text-align:right;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;">
                                            <a href="{{route('editardistbenemetas',array($ben->periodo_id,$ben->prog_id) )}}" class="btn badge-warning" title="Editar"><i class="fa fa-edit"></i></a>
                                            @if(session()->get('rango') == '4')
                                                <a href="{{route('borrardistbenemetas',array($ben->periodo_id,$ben->prog_id) )}}" class="btn badge-danger" title="Eliminar distribución anual de beneficios del programa" onclick="return confirm('¿Seguro que desea eliminar la distribución anual de beneficios?')"><i class="fa fa-times"></i></a>
                                            @endif    
                                        </td> 
                                    </tr>
                                    @if(session()->get('rango') == '0')
                                        <tr>
                                            <td style="text-align:left; rowspan=2;">
                                                ...
                                                <img src="{{ asset('images/b7.jpg') }}"   border="0" width="30" height="30" title="7.2 Dist. de beneficiarios avances">
                                                </a>                                            
                                            </td>
                                            ...
                                            <td style="text-align:right; ">
                                                <a href="{{route('verdistbeneavan')}}">       
                                                <img src="{{ asset('images/b8.jpg') }}"   border="0" width="30" height="30" title="8.2 Distribución de beneficios avances">
                                                </a>
                                            </td>
                                        </tr>
                                    @endif
