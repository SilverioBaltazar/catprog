...
<head>
    ...
    <title>@yield('title','BackOffice') | CATPROG v.1</title>
...
<div class="wrapper">
    ...
    <footer class="main-footer">
        <div class="pull-right hidden-xs"><b> UDITI.</b></div>
        <strong>Copyright &copy;. Derechos reservados. Secretaría de Desarrollo Social - Unidad de Desarrollo Institucional y Tecnologias de la Información (UDITI).
        </strong>
    </footer>
</div>
<!-- jQuery 3 -->
