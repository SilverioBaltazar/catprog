                        ...
                        <div class="box-body">
                            ...
                            <div class="row">                            
                                            ...
                                            @else
                                                ...
                                                @else
                                                    @if($user->status_1 == '1')
                                                        ...
                                                        <option value="4"         >Super Admon. </option>
                                                    @else
                                                        <option value="0" selected>Público general</option>
                                                        <option value="1"         >Operativo    </option>
                                                        <option value="2"         >Particular   </option>
                                                        <option value="3"         >Administrador</option>
                                                        <option value="4"         >Super Admon. </option>
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <select class="form-control m-bot15" name="cve_programa" id="cve_programa" required>
                                    <option selected="true" disabled="disabled">Seleccionar Programa y/o acción</option>
                                    @foreach($regprog as $programa)
                                        @if($programa->prog_id == $user->cve_programa)
                                            <option value="{{$programa->prog_id}}" selected>{{$programa->prog_id.' '.trim($programa->prog_desc)}}</option>
                                        @else 
                                            <option value="{{$programa->prog_id}}">{{$programa->prog_id.' '.trim($programa->prog_desc)}}</option>
                                        @endif                                    
                                    @endforeach
                                    </select>                           
                                </div>
