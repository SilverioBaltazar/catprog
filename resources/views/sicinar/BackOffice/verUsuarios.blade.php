                        ...
                        <div class="page-header" style="text-align:right;">                            
                            {{ Form::open(['route' => 'buscarUsuario', 'method' => 'GET', 'class' => 'form-inline pull-right']) }}
                                <div class="form-group">
                                    {{ Form::text('idd', null, ['class' => 'form-control', 'placeholder' => 'Cve. programa']) }}
                                </div>                                                             
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <a href="{{route('nuevoUsuario')}}" class="btn btn-info pull-right" title="Registrar nuevo usuario"><i class="fa fa-user-plus"></i>Nuevo</a>
                                </div>                                
                            {{ Form::close() }}
                        </div>
                            ...
                            <table id="tabla1" border="1" style="border: 2px solid slategray;" class="table table-bordered table-sm">
                                <thead style="border-color:brown;color: brown;" class="justify">
                                    <tr>
                                        ...
                                        <th colspan="1" style="text-align:center; vertical-align: middle;border: 2px solid slategray;"><b style="color: green">Programa</b>
                                        </th>
                                ...
                                @foreach($usuarios as $usuario)
                                    <tr>
                                        ...
                                        <td style="text-align:left; vertical-align:middle;">
                                            {{$usuario->cve_programa}}
                                            @foreach($regprog as $programa)
                                                @if($programa->prog_id == $usuario->cve_programa)
                                                    {{$programa->prog_desc}}
                                                    @break
                                                @endif
                                            @endforeach 
