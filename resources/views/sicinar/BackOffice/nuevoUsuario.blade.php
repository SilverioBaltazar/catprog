...
@section('content')
    <div class="content-wrapper" id="principal">
        <section class="content-header">
            <h1><i class="fa fa-users"></i>Usuarios - Nuevo</h1>
            <ol class="breadcrumb">
                ...
                <div class="col-md-12">
                    <div class="box box-danger">
                        <div class="box-header with-border">
                            <a href="{{route('verUsuarios')}}" class="btn btn-primary pull-right" title="Ver usuarios"><i class="fa fa-users"> Ver Usuarios</i></a>
                        </div>
