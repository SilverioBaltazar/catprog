            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarfinanpres1',$regfinanpres->periodo_id, $regfinanpres->prog_id], 'method' => 'PUT', 'id' => 'actualizarfinanpres1', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">                            
                            ...
                            @if (!empty($regfinanpres->finan_arc1)||!is_null($regfinanpres->finan_arc1))   
                                <div class="row">
                                    <div class="col-xs-6 form-group">
                                        ...
                                        <label ><a href="/images/{{$regfinanpres->finan_arc1}}" class="btn btn-danger" title="Subir archivo digital de Oficio y Expediente técnico Anexo 1 en formato PDF "><i class="fa fa-file-pdf-o"></i>PDF
                                ...
                                <div class="row">
                                    <div class="col-xs-6 form-group">
                                        <label >Actualizar archivo digital de Oficio y Expediente técnico Anexo 1 en formato PDF </label>
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\finanpres1Request','#actualizarfinanpres1') !!}
@endsection
