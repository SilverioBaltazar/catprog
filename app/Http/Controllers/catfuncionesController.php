...
class catfuncionesController extends Controller
{
    ...
    public function actionVerFuncion(){
        ...
        $regfuncion = regFuncionModel::join('CP_LU_PROCESOS','CP_LU_PROCESOS.PROCESO_ID','=','CP_LU_FUNCIONES.PROCESO_ID')
                                   ->select('CP_LU_FUNCIONES.PROCESO_ID','CP_LU_PROCESOS.PROCESO_DESC','CP_LU_FUNCIONES.FUNCION_ID','CP_LU_FUNCIONES.FUNCION_DESC','CP_LU_FUNCIONES.FUNCION_STATUS','CP_LU_FUNCIONES.FUNCION_FECREG')
                                   ->orderBy('CP_LU_FUNCIONES.PROCESO_ID','DESC')
                                   ->orderBy('CP_LU_FUNCIONES.FUNCION_ID','ASC')
                                   ->paginate(50);
    ...
    public function actionActualizarFuncion(funcionRequest $request, $id){
        $nombre        = session()->get('userlog');
        $pass          = session()->get('passlog');
        if($nombre == NULL AND $pass == NULL){
            return view('sicinar.login.expirada');
...
public function actionBorrarFuncion($id){
    ...
    public function exportCatFuncionesPdf(){
        ...
        $regfuncion = regFuncionModel::join('CP_LU_PROCESOS','CP_LU_PROCESOS.PROCESO_ID','=','CP_LU_FUNCIONES.PROCESO_ID')
                                   ->select('CP_LU_FUNCIONES.PROCESO_ID','CP_LU_PROCESOS.PROCESO_DESC','CP_LU_FUNCIONES.FUNCION_ID','CP_LU_FUNCIONES.FUNCION_DESC','CP_LU_FUNCIONES.FUNCION_STATUS','CP_LU_FUNCIONES.FUNCION_FECREG')
                                   ->orderBy('CP_LU_FUNCIONES.PROCESO_ID','ASC')
                                   ->orderBy('CP_LU_FUNCIONES.FUNCION_ID','ASC')
                                   ->get();
        if($regfuncion->count() <= 0){
